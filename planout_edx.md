...
| **Design**              | **Steps**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Factorial           | **Minitab** <br />- Stat → DOE → Create Factorial Design <br />- Factors → Specify Fat1 and Fat2 with 2 numeric levels(1 and 2) <br />- Designs → specify the number of replicates <br />- Will generate 5 columns with the order: StdOrder;RunOrder;PtType;Blocks;Fator1;Fator2 <br />- File → Save project <br />- File → Save worksheet as → Save as text(ANSI) → options → set the Single Character separator to Semicolon <br />**Edx CMS** <br />- Tools → Experiments → Define stratety → Factorial <br />-Open the file generated by Minitab, copy and past in the Textarea. - Save |
| Custom              | **JMP** <br />– DOE → Custom Design <br />– Add factor → Discrete Numeric → 2 level <br />- Values 0 and 1 - Specify the number of runs <br />- File → Save As → Text Export File(.txt) <br />**Edx CMS** <br />- Tools → Experiments → Define stratety → Customized <br />- Open the file generated by JMP, copy and past in the Textarea. <br />- Save                                                                                                                                                                                                                              |
| Custom with Scripts |  **Edx CMS** <br />- Tools → Experiments → Define stratety → planOut Script <br />- Define exactly what will be randomized. <br />- Insert the PlanOut script <br />- Compile <br />- Save                                                                                                                                                                                                                                                                                                                                                                        |
