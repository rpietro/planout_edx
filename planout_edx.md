...
| Design              | Steps                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Factorial           | Minitab - Stat → DOE → Create Factorial Design - Factors → Specify Fat1 and Fat2 with 2 numeric levels(1 and 2) - Designs → specify the number of replicates - Will generate 5 columns with the order: StdOrder;RunOrder;PtType;Blocks;Fator1;Fator2 - File → Save project - File → Save worksheet as → Save as text(ANSI) → options → set the Single Character separator to Semicolon - Edx CMS - Tools → Experiments → Define stratety → Factorial -Open the file generated by Minitab, copy and past in the Textarea. - Save |
| Custom              | JMP – DOE → Custom Design – Add factor → Discrete Numeric → 2 level - Values 0 and 1 - Specify the number of runs - File → Save As → Text Export File(.txt) - Edx CMS - Tools → Experiments → Define stratety → Customized - Open the file generated by JMP, copy and past in the Textarea. - Save                                                                                                                                                                                                                              |
| Custom with Scripts |  Edx CMS - Tools → Experiments → Define stratety,→ planOut Script - Define exactly what will be randomized. - Insert the PlanOut script - Compile - Save                                                                                                                                                                                                                                                                                                                                                                        |
...
### Visão geral dos designs possíveis 
A tabela abaixo submariza todos os designs implementados e formas que podem ser obtidas no protótipo.

|       Design       | Custom Design with PlanOut Script | Custom design generated by third-party softwares | Just selecting among the options |
|:------------------:|:---------------------------------:|:------------------------------------------------:|:--------------------------------:|
| Parallel           |                 x                 |                         x                        |                 x                |
| Proportional       |                 x                 |                         x                        |                 x                |
| Factorial          |                 x                 |                         x                        |                                  |
